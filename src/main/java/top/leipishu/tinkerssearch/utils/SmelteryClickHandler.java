...
public class SmelteryClickHandler {
    ...
    public static boolean clickFluidByName(FluidStack fluidStack) {
        ...
        ResourceLocation targetRl = ForgeRegistries.FLUIDS.getKey(fluidStack.getFluid());
        String targetRegistryName = targetRl != null ? targetRl.toString() : "";
        for (int i = 0; i < fluids.size(); i++) {
            ResourceLocation fsRl = ForgeRegistries.FLUIDS.getKey(fluids.get(i).getFluid());
            String registryName = fsRl != null ? fsRl.toString() : "";
    ...
    private static int findFluidIndex(List<FluidStack> fluids, FluidStack target) {
        ...
        ResourceLocation targetRl = ForgeRegistries.FLUIDS.getKey(target.getFluid());
        String targetRegistryName = targetRl != null ? targetRl.toString() : "";
        for (int i = 0; i < fluids.size(); i++) {
            ResourceLocation fsRl = ForgeRegistries.FLUIDS.getKey(fluids.get(i).getFluid());
            String registryName = fsRl != null ? fsRl.toString() : "";
